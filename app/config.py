...
class Settings:
    ...
    def load(cls) -> "Settings":
        ...
        return cls(
            ...
            channel_id=os.getenv("CHANNEL_ID", "@tgbots_miniapps"),
            discussion_chat=os.getenv("DISCUSSION_CHAT", "@tgtoolschat"),
            owner_ids=owners,
            timezone=os.getenv("TIMEZONE", "Europe/Moscow"),
            post_times=[x.strip() for x in os.getenv("POST_TIMES", "10:00,19:00").split(",") if x.strip()],
            ...
            high_performer_score=int(os.getenv("HIGH_PERFORMER_SCORE", "20")),
    ...
    def validate(self) -> None:
        ...
        if not self.discussion_chat:
            missing.append("DISCUSSION_CHAT")
        if missing:
